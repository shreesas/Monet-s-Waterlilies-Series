            ...
            <div className="absolute inset-0 flex items-center justify-start px-12 md:px-20 lg:px-28">
              ...
              >
                ...
                <button
                  ...
                  className="mt-10 rounded-full border-2 border-black/70 bg-transparent text-black/85 font-serif font-medium text-sm tracking-wide px-8 py-3 hover:bg-black hover:text-white hover:border-black transition-all duration-300"
                >
